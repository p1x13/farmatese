...
public class Colonia extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ID Colonia");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(40, 40, 60, 40);

        jLabel2.setText("Nombre Colonia");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(40, 100, 100, 20);
        getContentPane().add(claveco);
        claveco.setBounds(150, 40, 300, 30);
        getContentPane().add(nombre);
        nombre.setBounds(150, 90, 300, 30);
        ...
        jScrollPane1.setBounds(20, 140, 440, 108);
        ...
        jButton1.setBounds(290, 270, 70, 60);
        ...
        jButton3.setBounds(210, 270, 60, 60);
        ...
        jButton4.setBounds(120, 270, 70, 60);
        ...
        jButton6.setBounds(380, 270, 70, 57);

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("COLONIA");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(10, 10, 470, 22);
        ...
        jButton5.setBounds(21, 270, 80, 60);
        ...
        setSize(new java.awt.Dimension(493, 401));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try {
            ...
            ResultSet rs = stm.executeQuery("Select * from Colonia where ID_Col='"  + clave + "'");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (nombre.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Ingrese el nombre de la colonia");
        }
        String clave, nomco;
        clave = claveco.getText();
        nomco = nombre.getText();
        try {
            DefaultTableModel tabla = new DefaultTableModel();
            Connection con;
            con = DriverManager.getConnection(coneccionbd);
            Statement stm = con.createStatement();
            ResultSet rs = stm.executeQuery("insert into Colonia values ('" +  clave + "','" + nomco + "')");
        } catch (Exception e) {
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            con = DriverManager.getConnection(coneccionbd);
            Statement stm = con.createStatement();
            ResultSet rs = stm.executeQuery("delete from Colonia where ID_Col='"  + clave + "'");
        } catch (Exception e) {
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
         ...
         Claveco=claveco.getText();
            ...
            con = DriverManager.getConnection(coneccionbd);
            Statement stm = con.createStatement();
            ResultSet rs = stm.executeQuery("select * from Colonia where ID_Col='" +Claveco + "'");
           if(rs.next()){
               claveco.setText(String.valueOf(rs.getString(1)));
               nombre.setText(String.valueOf(rs.getString(2)));
               
               claveco.setEnabled(false);
