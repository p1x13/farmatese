...
public class Horario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        claveho = new javax.swing.JTextField();
        ...
        jLabel1.setBounds(10, 44, 60, 30);

        jLabel2.setText("Turno");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(10, 84, 80, 30);
        getContentPane().add(claveho);
        claveho.setBounds(100, 40, 350, 30);
        getContentPane().add(turno);
        turno.setBounds(100, 80, 350, 30);
        ...
        jScrollPane1.setBounds(10, 119, 440, 99);
        ...
        jLabel3.setBounds(0, 10, 470, 22);

        jPanel1.setBackground(new java.awt.Color(204, 255, 204));
        getContentPane().add(jPanel1);
        jPanel1.setBounds(0, -20, 480, 320);
        ...
        jMenuItem2.setText("Farmaceutico");
        ...
        setSize(new java.awt.Dimension(490, 352));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        String clave;
        clave = claveho.getText();
        try {
            DefaultTableModel tabla = new DefaultTableModel();
            Connection con;
            con = DriverManager.getConnection(coneccionbd);
            Statement stm = con.createStatement();
            ResultSet rs = stm.executeQuery("Select * from Horario where ID_Horario='"  + clave + "'");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        if (claveho.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Ingrese un ID");
        }
        if (turno.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Ingrese el turno");
        }
        String clave, tur;
        clave = claveho.getText();
        tur = turno.getText();
        try {
            ...
            con = DriverManager.getConnection(coneccionbd);
            Statement stm = con.createStatement();
            ResultSet rs = stm.executeQuery("insert into Horario values ('"  + clave + "','" + tur + "')");
        } catch (Exception e) {
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            con = DriverManager.getConnection(coneccionbd);
            Statement stm = con.createStatement();
            ResultSet rs = stm.executeQuery("delete from Horario where ID_Horario='"  + clave + "'");
        } catch (Exception e) {
        }
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        claveho.setText("");
        turno.setText("");
        claveho.setEnabled(true);
    }//GEN-LAST:event_jButton8ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
           try {
         String Claveho;
         Claveho=claveho.getText();
            Connection con;
            con = DriverManager.getConnection(coneccionbd);
            Statement stm = con.createStatement();
            ResultSet rs = stm.executeQuery("select * from Horario where ID_Horario='" +Claveho + "'");
           if(rs.next()){
               claveho.setText(String.valueOf(rs.getString(1)));
               turno.setText(String.valueOf(rs.getString(2)));
               
               claveho.setEnabled(false);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
     try {
        String Claveho, Turno;
        Claveho = claveho.getText();
        Turno = turno.getText(); 
            Connection con;
            con = DriverManager.getConnection(coneccionbd);
            Statement stm = con.createStatement();
            ResultSet rs = stm.executeQuery("ACT8 "+Claveho+",'"+Turno+"'");
    ...
    private javax.swing.JTextField claveho;
