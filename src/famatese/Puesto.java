...
public class Puesto extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        clavepu = new javax.swing.JTextField();
        ...
        jLabel1.setBounds(21, 47, 73, 14);

        jLabel2.setText("Nombre Puesto");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(21, 85, 110, 14);
        getContentPane().add(clavepu);
        clavepu.setBounds(143, 34, 300, 30);
        getContentPane().add(nombre);
        nombre.setBounds(143, 72, 300, 30);
        ...
        jScrollPane1.setBounds(10, 108, 440, 113);
        ...
        jButton1.setBounds(30, 240, 44, 39);
        ...
        jButton2.setBounds(90, 240, 44, 39);
        ...
        jButton3.setBounds(150, 240, 44, 39);
        ...
        jButton4.setBounds(210, 240, 44, 39);
        ...
        jButton5.setBounds(270, 240, 44, 39);
        ...
        jButton6.setBounds(330, 240, 44, 39);
        ...
        jButton8.setBounds(390, 240, 44, 39);
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(0, 24, 470, 30);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(0, -20, 480, 330);
        ...
        setSize(new java.awt.Dimension(488, 361));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
      String clave;
        clave=clavepu.getText();
        try {
            DefaultTableModel tabla = new DefaultTableModel();
            Connection con;
            con = DriverManager.getConnection(coneccionbd);
            Statement stm = con.createStatement();
            ResultSet rs = stm.executeQuery("Select * from Puesto where ID_Puesto='"+clave+"'");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try {
            ...
            con = DriverManager.getConnection(coneccionbd);
            Statement stm = con.createStatement();
            ResultSet rs = stm.executeQuery("Select * from Puesto");
            tabla.addColumn("ID Puesto");
            tabla.addColumn("Nombre Puesto");
            while (rs.next()) {
                Object dato[] = new Object[2];
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        String clave, nompu;
        clave = clavepu.getText();
        nompu = nombre.getText();
        try {
            DefaultTableModel tabla = new DefaultTableModel();
            Connection con;
            con = DriverManager.getConnection(coneccionbd);
            Statement stm = con.createStatement();
            ResultSet rs = stm.executeQuery("insert into Puesto values ('"+clave+"','"+nompu+"')");
        } catch (Exception e) {
        }  
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       String clave;
        ...
        try {
            ...
            con = DriverManager.getConnection(coneccionbd);
            Statement stm = con.createStatement();
            ResultSet rs = stm.executeQuery("delete from Puesto where ID_Puesto='"+clave+"'");
        } catch (Exception e) {
        }     
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        clavepu.setText("");
        nombre.setText("");
        clavepu.setEnabled(true);
    }//GEN-LAST:event_jButton8ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         try {
         String Clavepu;
         Clavepu=clavepu.getText();
            Connection con;
            con = DriverManager.getConnection(coneccionbd);
            Statement stm = con.createStatement();
            ResultSet rs = stm.executeQuery("select * from Puesto where ID_Puesto='" +Clavepu + "'");
           if(rs.next()){
               clavepu.setText(String.valueOf(rs.getString(1)));
               nombre.setText(String.valueOf(rs.getString(2)));
               
               clavepu.setEnabled(false);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
         try {
        String Clavepu, Nombre;
        Clavepu = clavepu.getText();
        Nombre = nombre.getText(); 
            Connection con;
            con = DriverManager.getConnection(coneccionbd);
            Statement stm = con.createStatement();
            ResultSet rs = stm.executeQuery("ACT2 "+Clavepu+",'"+Nombre+"'");
    ...
    private javax.swing.JTextField clavepu;
