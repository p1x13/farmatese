...
public class Unidad extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        claveum = new javax.swing.JTextField();
        ...
        jLabel1.setText("ID Unidad Medida");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(10, 54, 100, 30);

        jLabel2.setText("Tipo Unidad Medida");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(10, 104, 120, 30);
        getContentPane().add(claveum);
        claveum.setBounds(160, 50, 300, 30);
        getContentPane().add(tipo);
        tipo.setBounds(160, 100, 300, 30);
        ...
        jScrollPane1.setBounds(20, 150, 450, 98);
        ...
        jButton1.setBounds(20, 260, 44, 39);
        ...
        jButton2.setBounds(80, 260, 44, 39);
        ...
        jButton3.setBounds(140, 260, 44, 39);
        ...
        jButton4.setBounds(200, 260, 44, 39);
        ...
        jButton5.setBounds(260, 260, 44, 39);
        ...
        jButton8.setBounds(400, 260, 44, 39);
        ...
        jLabel3.setBounds(0, 14, 490, 20);

        jPanel1.setBackground(new java.awt.Color(204, 255, 204));
        getContentPane().add(jPanel1);
        jPanel1.setBounds(0, -20, 500, 360);
        ...
        setSize(new java.awt.Dimension(501, 390));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        String clave;
        clave=claveum.getText();
        try {
            DefaultTableModel tabla = new DefaultTableModel();
            Connection con;
            con = DriverManager.getConnection(coneccionbd);
            Statement stm = con.createStatement();
            ResultSet rs = stm.executeQuery("Select * from UnidadMed where ID_Umed='"+clave+"'");
            tabla.addColumn("ID Unidad Medida");
            tabla.addColumn("Tipo Unidad Medida");
            while (rs.next()) {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
       try {
            ...
            con = DriverManager.getConnection(coneccionbd);
            Statement stm = con.createStatement();
            ResultSet rs = stm.executeQuery("Select * from UnidadMed");
            tabla.addColumn("ID Unidad Medida");
            tabla.addColumn("Tipo Unidad Medida");
            while (rs.next()) {
                Object dato[] = new Object[2];
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        if(claveum.getText().equals("")){
            JOptionPane.showMessageDialog(null,"Ingrese un ID");
        }
        if(tipo.getText().equals("")){
            JOptionPane.showMessageDialog(null,"Ingrese el tipo de unidad de medida");
        }
        String clave, tipoum;
        clave = claveum.getText();
        tipoum = tipo.getText();
        try {
            ...
            con = DriverManager.getConnection(coneccionbd);
            Statement stm = con.createStatement();
            ResultSet rs = stm.executeQuery("insert into UnidadMed values ('"+clave+"','"+tipoum+"')");
        } catch (Exception e) {
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            con = DriverManager.getConnection(coneccionbd);
            Statement stm = con.createStatement();
            ResultSet rs = stm.executeQuery("delete from UnidadMed where ID_Umed='"+clave+"'");
        } catch (Exception e) {
        }
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        claveum.setText("");
        tipo.setText("");
        claveum.setEnabled(true);
    }//GEN-LAST:event_jButton8ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         try {
         String Claveum;
         Claveum=claveum.getText();
            Connection con;
            con = DriverManager.getConnection(coneccionbd);
            Statement stm = con.createStatement();
            ResultSet rs = stm.executeQuery("select * from UnidadMed where ID_Umed='" +Claveum + "'");
           if(rs.next()){
               claveum.setText(String.valueOf(rs.getString(1)));
               tipo.setText(String.valueOf(rs.getString(2)));
               
               claveum.setEnabled(false);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Tipo = tipo.getText(); 
            ...
            con = DriverManager.getConnection(coneccionbd);
            Statement stm = con.createStatement();
            ResultSet rs = stm.executeQuery("ACT9 "+Claveum+",'"+Tipo+"'");
    ...
    private javax.swing.JTextField claveum;
